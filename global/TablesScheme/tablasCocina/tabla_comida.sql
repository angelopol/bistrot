...
CREATE TABLE comida (
    ...
    ingredientes LONGTEXT NOT NULL -- representa el diccionario de los ingredientes y cantidades que usa la comida para preparase, en este formato: "ingrediente1:cantidad1;ingrediente2:cantidad2,..."
);
