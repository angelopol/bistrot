...
export const createComprasRouter = () => {
  ...
  //RUTA QUE NECESITA INVENTARIO :D
  ComprasRouter.get('/historial/:id', historialController.getById)
  ComprasRouter.patch('/historial-actualizar/:id', historialController.update)
